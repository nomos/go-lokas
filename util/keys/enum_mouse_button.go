...
const (
	...
	MOUSE_BUTTON_WHEEL_UP MOUSE_BUTTON  = 6 //WHEEL_UP
	MOUSE_BUTTON_WHEEL_DOWN MOUSE_BUTTON  = 7 //WHEEL_DOWN
)

var ALL_MOUSE_BUTTON protocol.IEnumCollection = []protocol.IEnum{MOUSE_BUTTON_NULL,MOUSE_BUTTON_LEFT,MOUSE_BUTTON_RIGHT,MOUSE_BUTTON_MIDDLE,MOUSE_BUTTON_EXTRA_1,MOUSE_BUTTON_EXTRA_2,MOUSE_BUTTON_WHEEL_UP,MOUSE_BUTTON_WHEEL_DOWN}


var ENUM_MOUSE_BUTTON = protocol.NewEnumCollection([]MOUSE_BUTTON{MOUSE_BUTTON_NULL,MOUSE_BUTTON_LEFT,MOUSE_BUTTON_RIGHT,MOUSE_BUTTON_MIDDLE,MOUSE_BUTTON_EXTRA_1,MOUSE_BUTTON_EXTRA_2,MOUSE_BUTTON_WHEEL_UP,MOUSE_BUTTON_WHEEL_DOWN})
