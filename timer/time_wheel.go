...
func (t *timeWheel) After(delay time.Duration, value interface{}) TimeNoder {
	jiffies := atomic.LoadUint64(&t.jiffies)
...
func (t *timeWheel) Schedule(interval time.Duration, value interface{}) TimeNoder {
	jiffies := atomic.LoadUint64(&t.jiffies)
...
func (t *timeWheel) TimeEventChan() <-chan interface{} {

	return t.timeEvent
}

// func (t *timeWheel) TriggerEvent() {
// 	t.timeEventChan <- struct{}{}
// }
